...
export 'package:highlight_sevice/highlight_link.dart'
    show
        LinkElement,
        LinkOptions,
        LinkableElement,
...
class LinkService extends StatelessWidget {
  ...
  /// HighlighLink to be used for link
  final List<HighlighLink> highlighLinks;
  ...
  const LinkService({
    Key? key,
    required this.text,
    this.highlighLinks = defaultHighlighLinks,
    this.onOpen,
...
/// Turns URLs into links
class SelectableLink extends StatelessWidget {
  /// Text to be linkified
  final String text;
...
class LinkSpan extends TextSpan {
  LinkSpan({
    ...
    super.spellOut,
          ...
          children: buildTextSpanChildren(
            link(text, options: options, highlighLinks: highlighLinks),
            style: style,
            linkStyle: linkStyle,
            onOpen: onOpen,
            useMouseRegion: useMouseRegion,
